...
export const BtnLeft = styled.button`
  height: 24px;
  max-height: 100%;
  ${(props) => (props.status ? `background: linear-gradient(180deg, #438AFE 0%, #82E3E3 100%);` : `background:#FFFFFF;`)}
...
export const BtnRight = styled.button`
  height: 24px;
  max-height: 100%;
  ${(props) => (Boolean(props.status) ? `background: linear-gradient(180deg, #438AFE 0%, #82E3E3 100%);` : `background:#FFFFFF;`)}
  border: 1px solid #F3F4F6;
  box-shadow: 0px 1px 5px rgba(0, 0, 0, 0.05);
